    ...
    <!-- -------------------------       index  start       ---------------------------    -->
        <div id="bokon" class="bokon tabs">
            <div id="mySidenav" class="sidenav">
                ...
                <a href="indexkan.php">Read in Kannada</a>
            </div>   
            <span class="fix lft top" style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; </span>
            <a href="indexkan.php" class="ritnil fix padrit">ಕನ್ನಡ</a>

            <div class="book_wrapper">		 
                <div id="mybook" style="display:none;">
                    <div class="b-load">
                        <div class="padtop"><img src="nightmode.png" alt="image not found" /></div>
                        <div class="border title"><center><p><h2>&nbsp;</h2></p><p><h2> Gurukul</h2></p></center></div>

                        <div class="padtop"><img src="daymode.png" alt="image not found" /></div>
                        <div class="border padnav"><center><h1>Welcome To Gurukul !</h1></center><p><?php echo $info['home'];?> </p> </div>

                        <div class="padtop"><img src="gallery/g22.jpg" alt="image not found" /></div>
                        <div class="border padnav"><center><h1>About Campus</h1></center><p><?php echo $info['campus'];?> </p> </div>

                        <div class="padtop"><img src="gm.jpg" alt="image not found" /></div>
                        <div class="border padnav"><center><h1>Message</h1></center><p><?php echo $info['message'];?> </p> </div>

                        <div class="padtop"><img src="gallery/g7.jpg" alt="image not found" /></div>
                        <div class="border padnav"><center><h1>Vision & Mission</h1></center><p><?php echo $info['vision'];?> </p> </div>

                        <div class="padtop"><img src="gallery/g2.jpg" alt="image not found" /></div>
                        <div class="border padnav"><center><h1>Computer Lab</h1></center><p><?php echo $info['computer'];?> </p> </div>

                        <div class="padtop"><img src="gallery/g20.jpg" alt="image not found" /></div>
                        <div class="border padnav"><center><h1>Science Lab</h1></center><p><?php echo $info['science'];?> </p> </div>

                        <div class="padtop"><img src="gallery/g16.jpg" alt="image not found" /></div>
                        <div class="border padnav"><center><h1>Library</h1></center><p><?php echo $info['library'];?> </p> </div>

                        <div class="padtop"><img src="gallery/g10.jpg" alt="image not found" /></div>
                        <div class="border padnav"><center><h1>Auditorium</h1></center><p><?php echo $info['auditorium'];?> </p> </div>

                        <div class="padtop"><img src="gallery/g13.jpg" alt="image not found" /></div>
                        <div class="border padnav"><center><h1>Sports</h1></center><p><?php echo $info['sports'];?> </p> </div>

                        <div class="padtop"><img src="gallery/g12.jpg" alt="image not found" /></div>
                        <div class="border padnav"><center><h1>Extra Curricular Activities</h1></center><p><?php echo $info['extra'];?></div>

                        <div class="padtop"><img src="gallery/g17.jpg" alt="image not found" /></div>
                        <div class="border padnav"><center><h1>Working Hours</h1></center><p><?php echo $info['working'];?> </p> </div>
 
                        <div class="border"></div>
                        <div class="border title"><center><br><h1>It's Time To<br><br>Create Your<br><br> Golden Page<br><br> In This Book . . .</h1></center> </div>
                    </div>
                </div>
            </div>
        </div>  
