...
<style>
    ...
    .left{float:left;}
    .right{float:right;}  
    .white{color:#fff;}    .black{color:black;}  .blue{color:blue;}
    ...
    .login{padding:3%; width:50%;height:50%; background-color:rgba(255,255,255,0.900); box-shadow: 0px 8px 16px 0px rgba(0,0,0,1.0); border-radius:15px;}
            ...
            <!-- -------------------------       navbar start       ------------------------------ -->
                    <center>
                        <div class="navbar " >                
                            ...
                            <div class="mode"><a href="indexnight.php"> &#127769;</a></div>
